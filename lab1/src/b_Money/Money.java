...
public class Money implements Comparable<Object> {
	...
	public String toString() {
		 double amountInDecimal = amount / 100.0;
	        return String.format("%.2f %s", amountInDecimal, currency.getName());
	}
	...
	public Boolean equals(Money other) {
		return this.currency.equals(other.currency) && this.universalValue().equals(other.universalValue());
	}
	...
	public Money add(Money other) {
        ...
        return new Money(amount + convertedAmount, this.currency);
	}
	...
	public int compareTo(Object other) {
		if (other == null || !(other instanceof Money)) {
	        throw new IllegalArgumentException("Invalid comparison object");
	    }
