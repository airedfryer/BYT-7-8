...
public class Bank {
	 ...
	 */
	public void transfer(String fromaccount, Bank tobank, String toaccount, Money amount) throws AccountDoesNotExistException, InsufficientFundsException {
	    if (!accountlist.containsKey(fromaccount) || !tobank.accountlist.containsKey(toaccount)) {
	        throw new AccountDoesNotExistException();
	    } else {
	        Account fromAccount = accountlist.get(fromaccount);
	        Account toAccount = tobank.accountlist.get(toaccount);
